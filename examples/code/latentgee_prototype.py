...
# --------------------------------------------------
# Experimental design & dataset builder
# --------------------------------------------------

BALANCED_STUDIES = [
    # "Mutlu", # cleanset filtering 후 제거됨 (missing covariates)
    "Dillon", 
    "Dinh",
    "Dubourg",
    "Nowak2017"
...
# --------------------------------------------------
# 1. VAE architecture with flexible encoder/decoder
# --------------------------------------------------
...
# --------------------------------------------------
# 2. ZILN_NLL (Zero-Inflated Log-Normal Negative Log-Likelihood)
# --------------------------------------------------
...
# --------------------------------------------------
# 5. LatentGEE evaluation pipeline
# --------------------------------------------------
"""
...
def objective(trial: optuna.Trial,
    ...
    scheduler_type      = trial.suggest_categorical("scheduler", config["search_space"]["training"]["scheduler"])
